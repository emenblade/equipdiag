...
2. Secure the number 1 column to the work table and lay the chains out on the floor. Note: Do not allow the chains to become twisted or dirty.
...
5. Lay the number 2 column chains on the floor. Note: Do not allow the chains to become twisted or dirty.
...
> **Note:** Confirm that all idler wheels rotate smoothly with no excessive side movement, or rub on the inside of the column.
