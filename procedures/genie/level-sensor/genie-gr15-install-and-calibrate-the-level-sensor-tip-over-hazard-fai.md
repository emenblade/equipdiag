# Install and Calibrate the Level Sensor
...
7. Turn the key switch to ground control and pull out the red Emergency Stop button to the on position at both the ground and platform controls.
8. Center a lifting jack under the drive chassis at the ground controls side of the machine.
9. Raise the machine approximately 2 inches / 5 cm.
