# Set Up the Oscillate Directional Valve

**Equipment:** Genie S-60 / S-65 / S-60 TRAX / S-65 TRAX

> **Note:** Adjustment of the oscillate directional valve linkage is only necessary when the linkage or valve has been replaced.
...
3. Check the tire pressure in all four tires and add air if needed to meet specification.  Note: The tires on some machines are foam-filled and do not need air added to them.
...
12. Measure the distance between the drive chassis and the non-steer axle on both sides (from the inside of the drive chassis).  Note: If the distance is not equal and the adjustment to the linkage was completed with the ground and drive chassis level, repeat steps 6 through 11 OR consult Genie Product Support.
