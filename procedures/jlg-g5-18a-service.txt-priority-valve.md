...
1. Park the machine on a firm, level surface, fully retract the boom, lower the boom, place the transmission in (N) NEUTRAL, engage the park brake and shut the engine OFF.
...
4. Install the previously labeled fittings in the priority valve housing.  c.   Priority Valve Installation
5. Label or otherwise mark the hydraulic hoses in relation to the priority valve. Disconnect and cap all hoses, fittings, etc.
6. Remove the capscrews that attach the valve to the frame.
