...
1. Remove the steer cylinder. Refer to Repair Procedure,   How to Remove the Steer Cylinder.
2. Remove the retaining fasteners from the steer links at each end of the bellcrank.  Note: While removing the retaining fasteners, take note of the quantity and location of the spacers between the bellcrank and the steer links.
...
> **Note:** Before re-installing the steer bellcrank onto the machine, apply a small amount of removable thread lock onto the threads of the fasteners.
