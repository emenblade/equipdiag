...
5. At the ground control, turn the key switch to the off position and push in the red Emergency Stop button to the off position.
...
7. Remove the fasteners securing the platform height sensor cover to the large platform height sensor bracket.
...
27. Secure the ends of the scissor arms together at the steer end of the machine with a strap or other suitable device.
...
> **Note:** When a Platform Height Sensor Assembly is removed or replaced, the platform overload system must be calibrated.
