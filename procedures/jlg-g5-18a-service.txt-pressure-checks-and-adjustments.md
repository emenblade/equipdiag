...
1. Park the machine on a firm, level surface. Engage the park brake, place the transmission in (N) NEUTRAL, place the neutral lock lever in the (N) NEUTRAL LOCK position, level the boom and turn the engine OFF.
