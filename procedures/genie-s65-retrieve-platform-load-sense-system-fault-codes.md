...
3. Determine whether a safety or operational fault exists by visually inspecting which controller has flashing LEDs.  Note: If the LEDs are flashing on both controllers, determine the fault code on one controller at a time.
