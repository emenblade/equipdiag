...
8. Repeat this procedure for each joystick controlled machine function including the thumb rocker steer switch.  Note: No machine function should operate while performing the joystick calibration procedure.

> **Note:** The joystick must be calibrated before the threshold, max-out or ramp rate can be set.
