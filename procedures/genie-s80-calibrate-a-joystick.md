...
7. Return the joystick to the neutral position, pause for a moment, then move the joystick full stroke in the opposite direction. Hold for 5 seconds.
8. Repeat this procedure for each joystick controlled machine function including the thumb rocker steer switch. Note: No machine fuction should operate while performing the joystick calibration procedure.

> **Note:** The joystick must be calibrated before the threshold, max-out or ramping can be set.

> **Note:** Perform this procedure with the engine off.

> **Note:** No machine fuction should operate while performing the joystick calibration procedure.
